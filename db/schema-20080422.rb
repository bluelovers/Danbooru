...
#   Unknown type 'post_status' for column 'status'
  ...
  add_index "server_keys", ["name"], :name => "index_server_keys_on_name", :unique => true
  ...
  create_table "user_blacklisted_tags", :force => true do |t|
    t.integer "user_id", :null => false
    t.text    "tags",    :null => false
  end

  add_index "user_blacklisted_tags", ["user_id"], :name => "index_user_blacklisted_tags_on_user_id"
...
#   Unknown type 'tsvector' for column 'text_search_index'
  ...
  add_foreign_key "flagged_post_details", ["post_id"], "posts", ["id"], :on_delete => :cascade, :name => "flagged_post_details_post_id_fkey"
  add_foreign_key "flagged_post_details", ["user_id"], "users", ["id"], :on_delete => :cascade, :name => "flagged_post_details_user_id_fkey"
  ...
  add_foreign_key "pools_posts", ["next_post_id"], "posts", ["id"], :on_delete => :set_null, :name => "pools_posts_next_post_id_fkey"
  add_foreign_key "pools_posts", ["prev_post_id"], "posts", ["id"], :on_delete => :set_null, :name => "pools_posts_prev_post_id_fkey"

  add_foreign_key "post_tag_histories", ["post_id"], "posts", ["id"], :on_delete => :cascade, :name => "fk_post_tag_histories__post"
  add_foreign_key "post_tag_histories", ["user_id"], "users", ["id"], :on_delete => :set_null, :name => "post_tag_histories_user_id_fkey"

  add_foreign_key "posts_tags", ["post_id"], "posts", ["id"], :on_delete => :cascade, :name => "fk_posts_tags__post"
  ...
  add_foreign_key "user_blacklisted_tags", ["user_id"], "users", ["id"], :on_delete => :cascade, :name => "user_blacklisted_tags_user_id_fkey"
