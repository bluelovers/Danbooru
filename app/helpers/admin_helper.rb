module AdminHelper
  def admin_link_to_user(user, positive_or_negative)
    ...
    if positive_or_negative == :positive
      html << " [" + link_to("+", {:controller => "user_record", :action => :create, :user_id => user.id, :user_record => {:is_positive => true}}, :target => "_blank") + "]"
      ...
      html << " [" + link_to("&ndash;", {:controller => "user_record", :action => :create, :user_id => user.id, :user_record => {:is_positive => false}}, :target => "_blank") + "]"
    end
    html
